...
17. [Spry: Literate Programming with Executable Markdown](spry-literate-programming.md) - Demonstrates how Spry implements Markdown-as-Code principles for documentation that executes as programs
